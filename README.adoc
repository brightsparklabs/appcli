...
Empty directories are backed up by default as some services require these directories to exist on a system restore.
However they will not match any include/exclude rules due to the limitations of Glob patterns.
